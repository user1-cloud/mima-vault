    ...
    () => [
      {
        ...
        restore: async (id) => {
          await store.restoreVault(id);
        },
        permanentDelete: async (id) => {
          await store.permanentlyDeleteVault(id);
        },
      ...
      },
      {
        ...
        restore: async (id) => {
          await store.restoreRecycleItem(id);
        },
        permanentDelete: async (id) => {
          await store.permanentlyDeleteRecycleItem(id);
        },
  ...
  return (
    <>
      ...
      <Modal
        ...
        onOpenChange={() => setPermDeleteId(null)}
      >
        <ModalBody>
          <ModalContent className="text-center">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <DangerButton
                onClick={() =>
                  permDeleteId !== null && handlePermDelete(permDeleteId)
                }
              >
                {t("permanentlyDelete")}
              </DangerButton>
