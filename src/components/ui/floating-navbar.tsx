...
export const FloatingNav = ({
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border border-oklch(0.92 0.004 286.32) border-white/10 bg-white/80 px-2 py-1.5 shadow-lg shadow-black/10 backdrop-blur-md dark:border-white/10 dark:bg-black/50 dark:border-oklch(1 0 0 / 10%)">
          {/* Nav items container */}
